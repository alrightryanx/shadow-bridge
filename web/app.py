...
def create_app():
    ...
    if getattr(sys, 'frozen', False):
        ...
        _debug_log(f"external_templates exists: {os.path.exists(external_templates)}", base_path)
        _debug_log(f"tools_templates: {tools_templates}", base_path)
        _debug_log(f"tools_templates exists: {os.path.exists(tools_templates)}", base_path)
